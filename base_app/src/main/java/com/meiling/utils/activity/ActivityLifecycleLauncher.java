 ...
 * 2022-01-26 14:20
 */
public class ActivityLifecycleLauncher implements LifecycleObserver {

    private ComponentActivity mComponentActivity;
    private ActivityResultLauncher<Intent> mLauncher;

    public ActivityLifecycleLauncher(@NonNull ComponentActivity componentActivity, @NonNull ActivityResultCallback<ActivityResult> activityResultCallback) {
    ...
    public void launchActivity(Class<?> cls, @Nullable Bundle bundle) {
        Intent intent = new Intent(mComponentActivity, cls);
